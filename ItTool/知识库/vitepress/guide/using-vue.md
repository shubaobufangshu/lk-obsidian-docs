...
::: details
<<< @/vitepress/components/ModalDemo.vue
:::
...
<script setup>
import ModalDemo from '/vitepress/components/ModalDemo.vue'
import ComponentInHeader from '/vitepress/components/ComponentInHeader.vue'
</script>

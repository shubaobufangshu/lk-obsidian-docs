...
```md
<<< @/vitepress/snippets/snippet.js{2}
```

**Code file**

<<< @/vitepress/snippets/snippet.js
...
```md
<<< @/vitepress/snippets/snippet-with-region.js#snippet{1}
```

**Code file**

<<< @/vitepress/snippets/snippet-with-region.js
...
```md
<<< @/vitepress/snippets/snippet.cs{c#}

<!-- 带行高亮: -->

<<< @/vitepress/snippets/snippet.cs{1,2,4-6 c#}

<!-- 带行号: -->

<<< @/vitepress/snippets/snippet.cs{1,2,4-6 c#:line-numbers}
```
...
<<< @/vitepress/snippets/snippet-with-region.js#snippet{1,2 ts:line-numbers} [snippet with region]
